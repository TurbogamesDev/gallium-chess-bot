...
class Engine:
    ...
    def getBestMoveByMinimax(self, board_state: BoardState, depth: int, maximizing_player: bool) -> tuple[list[chess.Move], int]:
        ...
        if maximizing_player:
            ...
            for (move, _) in board_state.getLegalMovesWithSAN():
                ...
                _, eval = self.getBestMoveByMinimax(new_board_state, depth - 1, False)
            ...
            for (move, _) in board_state.getLegalMovesWithSAN():
                ...
                _, eval = self.getBestMoveByMinimax(new_board_state, depth - 1, True)
